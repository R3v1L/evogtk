...
class _NotificationSystem(object):
    ...
    def __init__(self,appname,timeout=10000,
                 ...
                 inmediate=True,position=evogtk.NOTIF_BOTTOM_RIGHT,fading=True):
        """
    ...
    def __queue_process(self):
        ...
        """
        if self.__notifqueue and self.__queue_running and (self.__inmediate or not self.__current):    
            self.__prepare_current(self.__notifqueue.pop())
        return self.__queue_running
    ...
    def queue_msg(self,msg,title=None,color=None,icon=None,padding=10,permanent=False):
        """
