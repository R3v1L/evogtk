...
class _WidgetAccess(object):
    ...
    def __init__(self,widgets):
        ...
        accessmodules=dir(accessclasses)
        # Register default access classes
        for accessclassname in accessmodules:
            if accessclassname[:2]!='__':
                try:
                    # Import access class module
                    accessmodule=__import__('accessclasses.%s' % accessclassname,globals(),locals(),[accessclassname],-1)
    ...
    def __getattr__(self,name):
        ...
        if name not in ['__widgets','__accessmap','__initialized']:
            ...
            return super(_WidgetAccess,self).__getattr__(name)
    ...
    def __setattr__(self,name,value):
        ...
        if widget:
            ...
            return super(_WidgetAccess,self).__setattr__(name,value)
