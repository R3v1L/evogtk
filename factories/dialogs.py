...
class DialogFactory(object):
    ...
    def __init__(self,parent=None,defaultposition=None):
        """
        Class constructor
    ...
    def fileSelDialog(self,mode='open',title=None,multiple=False,curfolder=None,buttons=None,position=None,filters=None,default_filter=None):
        """
    ...
    def aboutDialog(self,metadata,license=None,licensewrap=False,position=None):
        ...
        if metadata.has_key('APP_CODENAME'):
            try:
                dialog.set_logo(gtk.gdk.pixbuf_new_from_file('./pixmaps/%s.png' % metadata['APP_CODENAME']))
            except:
                print '(EVOGTK - Dialog Factory) WARNING: Logo filename can not be loaded from ./pixmaps/%s.png' % metadata['APP_CODENAME']
        # Load license
    ...
    # Message dialog creation
    def statusDialog(self,title,msg,cancel=False,pulse_delay=500):
        """
        ...
        # Set pulse callback in the GTK main loop
        return dialog
